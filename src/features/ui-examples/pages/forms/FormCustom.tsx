...
import { Grid, Box, Typography, FormControl, MenuItem, RadioGroup, FormControlLabel, Button, SliderValueLabelProps, Stack } from 'src/shared/components/compat';
import { SliderThumb } from 'src/shared/components/compat';
...
import CustomSelect from 'src/shared/components/form-controls/CustomSelect';
import CustomSlider from 'src/shared/components/form-controls/CustomSlider';
import CustomRangeSlider from 'src/shared/components/form-controls/CustomRangeSlider';
import CustomSwitch from 'src/shared/components/form-controls/CustomSwitch';
import CustomDisabledButton from 'src/shared/components/form-controls/CustomDisabledButton';
import CustomOutlinedButton from 'src/shared/components/form-controls/CustomOutlinedButton';
...
import CustomRadio from 'src/shared/components/form-controls/CustomRadio';
                ...
                <FormControlLabel
                  control={
                    <CustomSwitch
                      disabled
                      sx={{
                        '& .UiSwitch-switchBase.Ui-disabled+.UiSwitch-track': {
                          opacity: 1,
                        },
                      }}
                    />
                ...
                <FormControlLabel
                  control={
                    <CustomSwitch
                      ...
                      disabled
                      sx={{
                        '& .UiSwitch-switchBase.Ui-checked.Ui-disabled': {
                          opacity: 0.5,
                        },
                      }}
                    />
