...
import { Card, CardContent, Typography, Button, Box, Grid } from 'src/shared/components/compat';
import trackBg from 'src/shared/assets/images/backgrounds/login-bg.svg';
