...
import { CardContent, Typography, Button, Avatar, Badge, Box, Stack } from 'src/shared/components/compat';
import userBg from 'src/shared/assets/images/profile/user-1.jpg';
