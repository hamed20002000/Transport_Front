...
import { Button, Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions, Box, FormControl, InputLabel, MenuItem, FormControlLabel } from 'src/shared/components/compat';
...
import { DialogProps } from 'src/shared/components/compat';
