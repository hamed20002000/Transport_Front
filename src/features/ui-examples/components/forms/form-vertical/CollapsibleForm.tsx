...
import { Accordion, AccordionSummary, AccordionDetails, Typography, Grid, FormControlLabel, RadioGroup, FormControl, InputAdornment, Stack, Button, MenuItem, Box } from 'src/shared/components/compat';
...
import CustomOutlinedInput from 'src/shared/components/form-controls/CustomOutlinedInput';
