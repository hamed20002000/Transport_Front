...
import { TableContainer, Table, TableRow, TableCell, TableBody, Avatar, Typography, TableHead, Chip, Box, AvatarGroup, Stack } from 'src/shared/components/compat';
import BlankCard from 'src/shared/components/BlankCard';
import { basicsTableData, TableType } from 'src/features/ui-examples/components/tables/tableData';
