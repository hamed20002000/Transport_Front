...
import { Box, Avatar, Typography, Chip, Button, Divider, Stack, IconButton, Grid, Tooltip, Paper, useTheme } from 'src/shared/components/compat';
import { EmailType } from 'src/features/email/types';
import { IconStar, IconAlertCircle, IconTrash } from '@tabler/icons-react';
import { useSelector, useDispatch } from 'src/app/store';
import { starEmail, importantEmail, deleteEmail } from 'src/features/email/model/EmailSlice';
