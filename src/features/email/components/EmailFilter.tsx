...
import { ListItemText, ListItemButton, List, Divider, ListItemIcon, Box, Typography } from 'src/shared/components/compat';

import { setVisibilityFilter } from 'src/features/email/model/EmailSlice';
import EmailCompose from 'src/features/email/components/EmailCompose';
...
import { GeneralIcon } from 'src/shared/types/apps/icon';
