...
import { TableContainer, Table, TableHead, TableRow, TableCell, TableBody, Typography, Chip, Menu, MenuItem, IconButton, ListItemIcon, Box, Stack, Grid, Button, Alert, TablePagination, TextField, InputAdornment, ToggleButtonGroup, ToggleButton, TableSortLabel } from 'src/shared/components/compat';
...
import DeleteSystemOperation from 'src/features/access-management/pages/system-operation/DeleteSystemOperation';
