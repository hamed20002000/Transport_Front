...
import { Dialog, DialogTitle, DialogContent, DialogActions, Button, TextField, Stack, IconButton, InputAdornment, CircularProgress, Typography, Box } from 'src/shared/components/compat';
