...
import { Button, Dialog, AppBar, Toolbar, IconButton, Typography, List, ListItem, ListItemText, ListItemIcon, Checkbox, CircularProgress, Box, DialogContent, DialogTitle, DialogActions, Accordion, AccordionSummary, AccordionDetails, FormControlLabel, FormGroup } from 'src/shared/components/compat';
                ...
                >
                  <AccordionSummary
                    ...
                    sx={{
                      ...
                      '&.Ui-expanded': { minHeight: '48px !important', },
                      '& .UiAccordionSummary-content': { margin: '12px 0 !important', },
