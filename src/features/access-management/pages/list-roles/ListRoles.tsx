...
import DeleteListRole from 'src/features/access-management/pages/list-roles/DeleteListRole';
import ListSystemOperationModal from 'src/features/access-management/pages/list-roles/ListSystemOperationModal';
...
import { Mic as MicIcon } from 'src/shared/components/compat/icons';
import { Send as SendIcon } from 'src/shared/components/compat/icons';
                        ...
                        >
                          ...
                          {Number(selectedRowForMenu?.id) !== 1 && hasChangeOpPermission && (
                            <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu rolün operasyonlarını seçin" : ""}>
                              <UiMenuItem onClick={handleClickOpenOperationModal}>
                                <ListItemIcon>
                                  <IconPlus width={18} />
                                </ListItemIcon>
                                Operasyon Seçin
