...
import { TableContainer, Table, TableHead, TableRow, TableBody, TableCell as UiTableCell, MenuItem as UiMenuItem, Typography, Menu, IconButton, ListItemIcon, Box, Stack, Grid, Button, Alert, TablePagination, TextField, InputAdornment, CircularProgress, Paper, ToggleButtonGroup, ToggleButton as UiToggleButton, TableSortLabel, Dialog, DialogTitle, DialogContent, DialogActions, Chip, DialogContentText, Autocomplete } from 'src/shared/components/compat';
import { keyframes, styled, useTheme } from 'src/shared/components/compat';
...
import DeletePersonnelConsigneds from 'src/features/human-resources/pages/PersonnelConsigneds/DeletePersonnelConsigneds';
                                                ...
                                                <Menu anchorEl={anchorEl} open={openMenu}
                                                    ...
                                                    {hasCreatePermission && ( 
                                                        <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu kayda ek dosya (resim/pdf) ekle veya mevcut ekleri düzenle." : ""}>
                                                            <UiMenuItem onClick={() => handleOpenAttachModal(selectedRowForMenu!)}>
                                                    ...
                                                    {hasDownloadPermission && selectedRowForMenu && (
                                                        ...
                                                        >
                                                            <UiMenuItem onClick={() => handleOpenLastRecordModalFromRow(selectedRowForMenu)}>
