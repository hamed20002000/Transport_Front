...
import { TableContainer, Table, TableHead, TableRow, TableBody, TableCell as UiTableCell, MenuItem as UiMenuItem, Typography, Menu, IconButton, ListItemIcon, Box, Stack, Grid, Button, Alert, TablePagination, TextField, InputAdornment, CircularProgress, Paper, FormControl, InputLabel, Select, ToggleButtonGroup, ToggleButton as UiToggleButton, TableSortLabel, Dialog, DialogTitle, DialogContent, DialogActions, Chip, OutlinedInput, Checkbox, ListItemText, SelectChangeEvent, DialogContentText, Autocomplete } from 'src/shared/components/compat';
                            ...
                            <Grid item xs={12} sm={4}>
                                ...
                                <FormControl size="small" sx={{ width: '100%' }}>
                                    ...
                                    <Select labelId="sel-placekind" label="Yer Türü Seçin" value={placeKind}
                                        ...
                                        <UiMenuItem value="WAREHOUSE">Depo</UiMenuItem>
                                        <UiMenuItem value="WORKHOUSE">Şantiye</UiMenuItem>
                                        <UiMenuItem value="WORKHOUSE_STORE">Şantiyenin Deposu</UiMenuItem>
                                        <UiMenuItem value="FILO">Filo</UiMenuItem>
                                    </Select>
                                </FormControl>
                            </Grid>
