...
import { TableContainer, Table, TableHead, TableRow, TableBody, Typography, Chip, Menu, IconButton, ListItemIcon, Box, TableCell as UiTableCell, MenuItem as UiMenuItem, Stack, Grid, Button, Alert, TablePagination, TextField, InputAdornment, TableSortLabel, Dialog, DialogTitle, DialogContent, DialogActions, CircularProgress, MenuItem, Select, Divider } from 'src/shared/components/compat';
...
import DeleteLeaves from "src/features/human-resources/pages/leaves/DeleteLeaves";
                                            ...
                                            <StyledTableCell>
                                                ...
                                                <Menu id="row-menu" anchorEl={anchorEl} open={openMenu} onClose={handleCloseMenu} MenuListProps={{ "aria-labelledby": `row-menu-${selectedRow?.id}` }}>
                                                    ...
                                                    {hasEditPermission && selectedRow?.status === 0 && (
                                                        <>
                                                            <UiMenuItem onClick={() => updateLeaveStatus(selectedRow.id, 1)}>
                                                                <ListItemIcon><DoneRoundedIcon width={18} /></ListItemIcon> Onayla
                                                            </UiMenuItem>
                                                            <UiMenuItem onClick={() => updateLeaveStatus(selectedRow.id, 2)}>
