...
import DeleteConsignment from 'src/features/human-resources/pages/Consignments/DeleteConsignment';
                            ...
                            <Grid item xs={12} sm={4}>
                                ...
                                <FormControl size="small" sx={{ width: '100%' }}>
                                    ...
                                    <Select labelId="sel-placekind" label="Yer Türü Seçin" value={placeKind}
                                        ...
                                        <UiMenuItem value="CENTER">Merkez</UiMenuItem>
                                                ...
                                                <Menu anchorEl={anchorEl} open={openMenu} onClose={handleCloseMenu}>
                                                    ...
                                                    {(selectedRowForMenu?.code && hasDownloadPermission) && (
                                                        <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu kaydın QR Kodunu indir" : ""}>
                                                            ...
                                                            <UiMenuItem onClick={() => handleOpenQrModal(selectedRowForMenu as Consignment)}>
                                                                <ListItemIcon>
                                                                    <IconQrcode width={18} />
                                                                </ListItemIcon>
                                                                QR Kod İndir
                                                    ...
                                                    {(selectedRowForMenu) && (
                                                        <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Kayıt detaylarını ve eklerini görüntüle" : ""}>
                                                            <UiMenuItem onClick={() => handleOpenAttachmentsModal(selectedRowForMenu!)}>
