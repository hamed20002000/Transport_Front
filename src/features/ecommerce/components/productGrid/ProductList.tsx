...
import { Box, Grid, Stack, CardContent, useMediaQuery, Typography, Rating, Fab, Tooltip, Button, Theme, Skeleton } from 'src/shared/components/compat';
...
import {
  ...
  addToCart,
  filterReset,
} from 'src/features/ecommerce/model/ECommerceSlice';
import ProductSearch from 'src/features/ecommerce/components/productGrid/ProductSearch';
import { IconBasket, IconMenu2 } from '@tabler/icons-react';
import AlertCart from 'src/features/ecommerce/components/productCart/AlertCart';
import emptyCart from 'src/shared/assets/images/products/empty-shopping-cart.svg';
