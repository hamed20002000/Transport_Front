...
import { ListItemText, ListItemButton, List, Divider, FormGroup, ListItemIcon, FormControlLabel, Radio, Typography, Box, Avatar, Button, Stack } from 'src/shared/components/compat';
import {
  filterProducts,
  sortByProducts,
  sortByGender,
...
import { ProductFiterType } from 'src/features/ecommerce/types';
