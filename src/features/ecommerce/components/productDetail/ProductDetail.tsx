...
// MUI Elements
import { Box, Grid, Typography, Chip, Button, Rating, Divider, Stack, useTheme, Fab, ButtonGroup } from 'src/shared/components/compat';

import { useSelector, useDispatch } from 'src/app/store';
import { fetchProducts, addToCart } from 'src/features/ecommerce/model/ECommerceSlice';
