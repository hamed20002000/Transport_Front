...
import { alpha, useTheme } from 'src/shared/components/compat';
import { format } from 'date-fns';
import { Box, Table, TableBody, TableCell, TableContainer, TableHead, TablePagination, TableRow, TableSortLabel, Toolbar, IconButton, Tooltip, FormControlLabel, Typography, Avatar, TextField, InputAdornment, Paper } from 'src/shared/components/compat';
import { visuallyHidden } from 'src/shared/components/compat';
import { useSelector, useDispatch } from 'src/app/store';
import { fetchProducts } from 'src/features/ecommerce/model/ECommerceSlice';
