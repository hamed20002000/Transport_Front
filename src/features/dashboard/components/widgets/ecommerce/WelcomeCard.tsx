...
import { Box, Avatar, Typography, Card, CardContent, Grid, Divider, Stack } from 'src/shared/components/compat';
import { IconArrowUpRight } from '@tabler/icons-react';

import welcomeImg from 'src/shared/assets/images/backgrounds/welcome-bg.svg';
