...
import { Stack, Typography, Avatar, Box, Button } from 'src/shared/components/compat';
import DashboardCard from 'src/shared/components/DashboardCard';

import icon1Img from "src/shared/assets/images/svgs/icon-paypal.svg"
import icon2Img from "src/shared/assets/images/svgs/icon-office-bag.svg"
import icon3Img from "src/shared/assets/images/svgs/icon-master-card.svg"
import icon4Img from "src/shared/assets/images/svgs/icon-pie.svg"
