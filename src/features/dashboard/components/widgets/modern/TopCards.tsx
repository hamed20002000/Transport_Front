...
import { Box, CardContent, Grid, Typography, CircularProgress } from 'src/shared/components/compat';
import { useNavigate } from 'react-router-dom';
import axios from 'axios';
import server from 'src/core/config/endpoints.json';

import icon2 from 'src/shared/assets/images/svgs/icon-user-male.svg';
import icon3 from 'src/shared/assets/images/svgs/icon-park-gavel.svg';
import icon4 from 'src/shared/assets/images/svgs/icon-work.svg';
