...
import { Box, CardContent, Chip, Paper, Stack, Typography, LinearProgress } from 'src/shared/components/compat';
import { useTheme } from 'src/shared/components/compat';
import SavingsImg from 'src/shared/assets/images/backgrounds/piggy.png';
