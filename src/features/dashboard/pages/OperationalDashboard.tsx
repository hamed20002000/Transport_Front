...
import { Box, Grid, CircularProgress, Card, CardContent, Typography, Avatar, Chip, Divider, Stack, Link } from 'src/shared/components/compat';
import { Business as BusinessIcon, Phone as PhoneIcon, Language as LanguageIcon, Person as PersonIcon, CheckCircle as CheckCircleIcon, Cancel as CancelIcon } from 'src/shared/components/compat/icons';

import PageContainer from 'src/shared/components/container/PageContainer';
import Welcome from 'src/app/layouts/full/shared/welcome/Welcome';
import { useAuth } from 'src/core/auth/AuthContext';

import DashboardStats from 'src/features/dashboard/components/DashboardStats';
import WorkhouseBetonStats from 'src/features/dashboard/components/WorkhouseBetonStats';
import WorkhouseSalaryStats from 'src/features/dashboard/components/WorkhouseSalaryStats';
import WorkhouseFuelStats from 'src/features/dashboard/components/WorkhouseFuelStats';
import WorkhouseDispatchStats from 'src/features/dashboard/components/WorkhouseDispatchStats';
import ProjectOverallStats from 'src/features/dashboard/components/ProjectOverallStats';
