...
import DeleteWarehouse from 'src/features/warehouse/pages/list-warehouse/DeleteWarehouse';
...
import ViewWarehouseBalanceModal from 'src/features/warehouse/pages/list-warehouse/ViewWarehouseBalanceModal';
                                                ...
                                                >
                                                    {hasCreatePermission && (
                                                        <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Depolar arası transfer başlat" : ""}>
                                                            <UiMenuItem onClick={handleWarehouseTransferClick}>
                                                    ...
                                                    <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Depo'dan geri gönderme Sevk İşlemi" : ""}>
                                                        <UiMenuItem onClick={handleDepoDispatchReturnToCenterClick}>
                                                    ...
                                                    {hasCreatePermission && (
                                                        <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Depo Sevk İşlemi" : ""}>
                                                            <UiMenuItem onClick={handleDispatchClick}>
                                                    ...
                                                    {hasCreatePermission && (
                                                        <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Depo envanterini görüntüle" : ""}>
                                                            <UiMenuItem onClick={handleViewBalanceClick}>
