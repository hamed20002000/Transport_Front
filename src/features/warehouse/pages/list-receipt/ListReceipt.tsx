...
import { TableContainer, Table, TableHead, TableRow, TableBody, TableCell as UiTableCell, MenuItem as UiMenuItem, Typography, Menu, IconButton, Box, Stack, Grid, Alert, TablePagination, TextField, InputAdornment, Dialog, DialogTitle, DialogContent, DialogActions, Button, Paper, CircularProgress, Autocomplete, TableSortLabel, useMediaQuery, DialogContentText } from 'src/shared/components/compat';
...
import ReceiptItemsTable from 'src/features/warehouse/pages/list-receipt/ReceiptItemsTable';
import DeleteReceiptModal from 'src/features/warehouse/pages/list-receipt/DeleteReceipt';
import { CustomTooltip, useTooltip } from 'src/shared/components/tooltip/TooltipContext';
import logoSrc from 'src/shared/assets/images/logos/logo.png';
...
import {
    ...
    ReceiptType,
    InvoiceType
} from 'src/features/warehouse/pages/list-receipt/types';
                                                ...
                                                >
                                                    ...
                                                    {hasDeletePermission && (
                                                        <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu Fişی silin" : ""}>
                                                            <UiMenuItem onClick={() => handleClickOpenDeleteModal(row.id)}>
                                                    ...
                                                    {hasDownloadPermission && (
                                                        <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu Fişi PDF olarak indirin" : ""}>
                                                            <UiMenuItem onClick={() => handleDownloadReceiptDetailsClicked(row)}>
