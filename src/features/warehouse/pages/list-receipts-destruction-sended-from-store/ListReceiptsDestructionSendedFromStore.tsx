...
import { TableContainer, Table, TableHead, TableRow, TableBody, TableCell as UiTableCell, MenuItem as UiMenuItem, Typography, Menu, IconButton, ListItemIcon, Box, Stack, Grid, Button, Alert, TablePagination, TextField, InputAdornment, CircularProgress, Paper, Autocomplete, Dialog, DialogTitle, DialogContent, DialogActions, Chip, RadioGroup, FormControlLabel, Radio, DialogContentText } from 'src/shared/components/compat';
...
import DeleteReceiptsDestructionSendedFromStore from "src/features/warehouse/pages/list-receipts-destruction-sended-from-store/DeleteReceiptsDestructionSendedFromStore";
