...
import { TableContainer, Table, TableHead, TableRow, TableBody, Typography, Box, TableCell as UiTableCell, Stack, Alert, CircularProgress, Button, Tooltip, Dialog, DialogTitle, DialogContent, DialogActions, Grid, TextField, IconButton, InputAdornment, Menu, ListItemIcon, Autocomplete, MenuItem, TableFooter, TableSortLabel, TablePagination } from 'src/shared/components/compat';
