...
import { TableContainer, Table, TableHead, TableRow, TableBody, Typography, Box, TableCell as UiTableCell, Stack, Alert, CircularProgress, Button, Tooltip, Dialog, DialogTitle, DialogContent, DialogActions, Grid, TextField, Menu, ListItemIcon, Autocomplete, IconButton, MenuItem, InputAdornment, TableSortLabel, TablePagination, TableFooter } from 'src/shared/components/compat';
