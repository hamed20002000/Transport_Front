...
import { Grid, Box, Typography, Stack, Avatar, Autocomplete, TextField, Skeleton, Button, Paper } from 'src/shared/components/compat';
import { styled, alpha } from 'src/shared/components/compat';
