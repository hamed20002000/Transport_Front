...
import { Box, Grid, Card, Typography, Stack, Button, Avatar, Dialog, DialogTitle, DialogContent, DialogActions, CircularProgress, IconButton, Paper, TextField, TablePagination } from 'src/shared/components/compat';
import {
