...
import { TableContainer, Table, TableHead, TableRow, TableBody, Typography, Box, TableCell as UiTableCell, Stack, Alert, CircularProgress, Button, Tooltip, Grid, TextField, IconButton, InputAdornment, Autocomplete, TableFooter, TableSortLabel, TablePagination, Chip, Menu, MenuItem, ListItemIcon, Dialog, DialogTitle, DialogContent, DialogActions, Divider, TableCell, ToggleButtonGroup, ToggleButton as UiToggleButton } from 'src/shared/components/compat';
