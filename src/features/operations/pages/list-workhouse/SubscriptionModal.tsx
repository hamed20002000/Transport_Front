...
import { Dialog, DialogTitle, DialogContent, DialogActions, Button, Grid, FormGroup, FormControlLabel, Checkbox, FormHelperText, Typography, TextField } from 'src/shared/components/compat';
