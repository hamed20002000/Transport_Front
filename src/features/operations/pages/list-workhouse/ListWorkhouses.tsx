...
import { TableContainer, Table, TableHead, TableRow, TableBody, TableCell as UiTableCell, MenuItem as UiMenuItem, Typography, Chip, Menu, IconButton, ListItemIcon, Box, Stack, Grid, Button, Alert, TablePagination, TextField, InputAdornment, CircularProgress, Paper, FormControl, InputLabel, Select, List, ListItemText, ToggleButtonGroup, ToggleButton as UiToggleButton, TableSortLabel, Autocomplete, Dialog, DialogTitle, DialogContent, DialogActions } from 'src/shared/components/compat';
...
import DeleteWorkhouse from 'src/features/operations/pages/list-workhouse/DeleteWorkHouse';
                                                ...
                                                >
                                                    {hasCreatePermission && (
                                                        <>
                                                            <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Detayları kaydet" : ""}>
                                                                <UiMenuItem onClick={handleNavigateToDetails}>
                                                            ...
                                                            <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Depoyu bu projeye ekle" : ""}>
                                                                <UiMenuItem onClick={handleInsertStoresClick}>
                                                    ...
                                                    {hasCreatePermission && selectedRowForMenu && selectedRowForMenu.endDate === null && (
                                                        <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Çalışan atama sayfasına git" : ""}>
                                                            <UiMenuItem onClick={handleAssignPersonnel}>
                                                    ...
                                                    {hasEditPermission && selectedRowForMenu && (
                                                        <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu şantiyeyi kapat (Pasif yap)" : ""}>
                                                            <UiMenuItem onClick={handleOpenCloseWorkhouseModal}>
