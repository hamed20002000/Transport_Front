...
import { Typography, Box, Stack, Grid, Button, Alert, TextField, CircularProgress, Paper, Chip, IconButton, TableContainer, Table, TableHead, TableRow, TableBody, Menu, ListItemIcon, TablePagination, TableCell as UiTableCell, MenuItem as UiMenuItem, Dialog, DialogTitle, DialogActions, DialogContent } from 'src/shared/components/compat';
...
import DeleteWorkhouseDetail from 'src/features/operations/pages/list-workhouse/DeleteWorkhouseDetail';
import SubscriptionModal from 'src/features/operations/pages/list-workhouse/SubscriptionModal';
                                        ...
                                        <StyledTableCell>
                                            ...
                                            >
                                                <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu kaydı düzenle" : ""}>
                                                    <UiMenuItem onClick={() => handleEditClick(selectedRowForMenu)}>
                                                        <ListItemIcon><IconEdit width={18} /></ListItemIcon>
                                                        Düzenle
                                                    </UiMenuItem>
                                                </CustomTooltip>
                                                <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu kaydı sil" : ""}>
                                                    <UiMenuItem onClick={() => handleClickOpenDeleteModal(selectedRowForMenu)}>
