...
import { TableContainer, Table, TableHead, TableRow, TableBody, TableCell as UiTableCell, MenuItem as UiMenuItem, Typography, Chip, Menu, IconButton, ListItemIcon, Box, Stack, Grid, Button, Alert, TablePagination, TextField, InputAdornment, CircularProgress, Paper, ToggleButtonGroup, ToggleButton as UiToggleButton, TableSortLabel, FormControl, InputLabel, Select, ListItemText, Autocomplete, List, Dialog, DialogTitle, DialogContent, DialogActions } from 'src/shared/components/compat';
import "src/features/operations/pages/store/style.css"
...
import DeleteStore from 'src/features/operations/pages/store/DeleteStore';
...
import ViewStoreBalanceModal from 'src/features/operations/pages/store/ViewStoreBalanceModal'
                                            ...
                                            <StyledTableCell>
                                                ...
                                                >
                                                    <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Şantiyenin Depo arası sevk sayfasına git" : ""}>
                                                        <UiMenuItem onClick={handleStoreTransferClick}>
                                                    ...
                                                    <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Şantiyenin Depo Sevk İşlemi" : ""}>
                                                        <UiMenuItem onClick={handleStoreDispatchClick}>
                                                    ...
                                                    <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu Şantiyenin Depo fişlerine git" : ""}>
                                                        <UiMenuItem onClick={() => { if (selectedRowForMenu) { navigate(`/store/list-store-receipt/${selectedRowForMenu.id}`); handleCloseMenu(); } }}>
                                                    ...
                                                    <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Depo'dan Merkeze Sevk İşlemi" : ""}>
                                                        <UiMenuItem onClick={handleStoreDispatchToCenterClick}>
                                                    ...
                                                    <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Depo'dan geri gönderme Sevk İşlemi" : ""}>
                                                        <UiMenuItem onClick={handleStoreDispatchReturnToCenterClick}>
                                                    ...
                                                    {hasDownloadPermission && (
                                                        <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu Şantiyenin Depo indir" : ""}>
                                                            <UiMenuItem onClick={() => handleOpenRowDownloadModal(row)}>
