...
import { Typography, Box, Stack, Button, CircularProgress, Paper, Chip, IconButton, TableContainer, Table, TableHead, TableRow, TableBody, Menu, ListItemIcon, TablePagination, MenuItem as UiMenuItem, Dialog, DialogTitle, DialogActions, DialogContent, TextField, Divider } from 'src/shared/components/compat';
