...
import { Typography, Box, Stack, Alert, Tab, TableCell as UiTableCell, Dialog, DialogTitle, DialogActions, DialogContent, Button, Divider, DialogContentText, Chip, Paper } from 'src/shared/components/compat';
...
import MaterialReceiptList from "src/features/operations/pages/list-request-receipt/MaterialReceiptList";
import RentalReceiptList from "src/features/operations/pages/list-request-receipt/RentalReceiptList";
...
export const StyledTableCell = styled(UiTableCell)(({ theme }) => ({
