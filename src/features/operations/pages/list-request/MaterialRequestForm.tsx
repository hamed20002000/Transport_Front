...
import { Typography, Box, Stack, Grid, Button, Paper, Chip, Autocomplete, TextField, CircularProgress } from 'src/shared/components/compat';
...
import { MaterialRequestType } from 'src/features/operations/pages/list-request/RequestTabs';
