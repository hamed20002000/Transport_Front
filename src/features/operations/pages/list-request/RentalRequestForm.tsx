...
import { Typography, Box, Stack, Grid, Button, Paper, Chip, TextField, InputAdornment, Autocomplete } from 'src/shared/components/compat';
...
import { WorkhouseRentRequest, Workhouse } from 'src/features/operations/pages/list-request/RequestTabs';
