...
import { Typography, Box, Stack, Grid, Button, Alert, CircularProgress, Paper, Chip, IconButton, TableContainer, Table, TableHead, TableRow, TableBody, TablePagination, TableCell as UiTableCell, Dialog, DialogTitle, DialogActions, DialogContent, DialogContentText, Divider, TextField, InputAdornment, ToggleButtonGroup, FormControl, ToggleButton as UiToggleButton, TableSortLabel, Tab, Autocomplete } from 'src/shared/components/compat';
...
import MaterialRequestForm from "src/features/operations/pages/list-request/MaterialRequestForm";
import RentalRequestForm from "src/features/operations/pages/list-request/RentalRequestForm";
import ActionMenu from "src/features/operations/pages/list-request/ActionMenu";
