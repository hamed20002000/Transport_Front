...
import { Alert, Autocomplete, Box, Button, Chip, CircularProgress, Dialog, DialogActions, DialogContent, DialogTitle, Grid, IconButton, InputAdornment, ListItemIcon, Menu, MenuItem as UiMenuItem, Paper, Radio, RadioGroup, FormControlLabel, Stack, Table, TableBody, TableCell as UiTableCell, TableContainer, TableHead, TablePagination, TableRow, TextField, ToggleButton as UiToggleButton, ToggleButtonGroup, Typography, DialogContentText } from 'src/shared/components/compat';
...
import DeleteStoreReceiptInvoice from "src/features/operations/pages/store-receipt-invoice/DeleteStoreReceiptInvoice";
                        ...
                        <Grid item xs={12}>
                            ...
                            <Autocomplete
                                ...
                                onChange={(_e, v) => {
                                    ...
                                    setRemovedReceiptDetails([]);
                                    if (v?.invoiceDetails) {
                                        const details: FormReceiptDetail[] = v.invoiceDetails.map((d: InvoiceDetailFromList) => ({
                                            itemId: Number(d.item.id),
                                            quantity: Number(d.quantity),
                                            description: d.description || "",
                                            ...
                                            <TableRow key={row.id}>
                                                ...
                                                <StyledTableCell>
                                                    ...
                                                    <Menu anchorEl={anchorEl} open={Boolean(anchorEl) && selectedRowForMenu?.id === row.id} onClose={handleCloseMenu}>
                                                        ...
                                                        {hasDownloadPermission && (
                                                            <UiMenuItem onClick={() => { setSelectedReceiptForDownload(row); setOpenRowDownloadModal(true); handleCloseMenu(); }}>
