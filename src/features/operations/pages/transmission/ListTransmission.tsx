...
import { Typography, Box, Stack, Grid, Button, CircularProgress, TextField, Autocomplete, RadioGroup, FormControlLabel, Radio, Paper, TableContainer, Table, TableHead, TableRow, TableCell, TableBody, IconButton, Chip, Menu, ListItemIcon, TablePagination, MenuItem, TableSortLabel, Dialog, DialogTitle, DialogContent, DialogActions, Alert, DialogContentText, InputAdornment, useMediaQuery } from 'src/shared/components/compat';
...
import MapPreviewModal from 'src/features/operations/pages/transmission/MapPreviewModal';
import FinalCalculationModal from 'src/features/operations/pages/transmission/FinalCalculationModal';
import DeleteTransmissionModal from 'src/features/operations/pages/transmission/DeleteTransmissionModal';
import DeleteAllConfirmationModal from 'src/features/operations/pages/transmission/DeleteAllConfirmationModal';
import RegisterNewNodesModal from 'src/features/operations/pages/transmission/RegisterNewNodesModal';
import { keyframes, styled } from 'src/shared/components/compat';

import { MapNode, TransmissionRow, SelectOption, AddedItem, ItemType, ProductTypesType } from 'src/features/operations/pages/transmission/types';
                        ...
                        <Grid container spacing={2} alignItems="flex-end">
                            <Grid item xs={12} sm={4}>
                                ...
                                <Autocomplete
                                    ...
                                    sx={{ '& .UiAutocomplete-inputRoot': { py: 0.5 } }}
