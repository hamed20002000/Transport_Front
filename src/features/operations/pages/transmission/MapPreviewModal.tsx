...
import { Dialog, DialogTitle, DialogContent, DialogActions, Button, Typography, Box, Stack, IconButton, ToggleButtonGroup, ToggleButton as UiToggleButton, Tooltip, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, CircularProgress, Divider, Grid, TextField } from 'src/shared/components/compat';
import { useTheme, styled, Theme } from 'src/shared/components/compat';
import { useMediaQuery } from 'src/shared/components/compat';
import {
...
import AddTransmissionDetailsModal from 'src/features/operations/pages/transmission/AddTransmissionDetailsModal';
import SelectTrafoModal from 'src/features/operations/pages/transmission/SelectTrafoModal';
import SelectProductTypeModal from 'src/features/operations/pages/transmission/SelectProductTypeModal';
import { MapNode, TransmissionRow, SelectOption, AddedItem, ItemType, MiktarTipi, D3MapLink, MapEdge, ProductTypesType } from 'src/features/operations/pages/transmission/types';
...
const StyledToolButton = styled(UiToggleButton)(({ theme }) => ({
    '&.Ui-selected': {
