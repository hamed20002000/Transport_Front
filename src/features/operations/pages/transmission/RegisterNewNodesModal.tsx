...
import { Dialog, DialogTitle, DialogContent, DialogActions, Button, Typography, CircularProgress, Chip, Stack, Alert } from 'src/shared/components/compat';
import axios from 'axios';
import server from 'src/core/config/endpoints.json';

import { MapNode, SelectOption } from 'src/features/operations/pages/transmission/types';
