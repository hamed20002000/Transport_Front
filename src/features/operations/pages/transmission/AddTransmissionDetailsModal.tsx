...
import { Dialog, DialogTitle, DialogContent, DialogActions, Button, Stack, TextField, Autocomplete, RadioGroup, FormControlLabel, Radio, IconButton, Box, Chip, Typography } from 'src/shared/components/compat';
import { IconPlus } from '@tabler/icons-react';
import CustomFormLabel from 'src/shared/components/form-controls/CustomFormLabel';

import { MapNode, SelectOption, AddedItem, MiktarTipi, ItemType } from 'src/features/operations/pages/transmission/types';
