...
import { Button, Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions, CircularProgress, Box, Typography } from 'src/shared/components/compat';
import { IconTrash } from '@tabler/icons-react';

import { TransmissionRow } from 'src/features/operations/pages/transmission/types';
type Props = {
    openModal: boolean;
    onClose: () => void;
    onConfirm: () => void;
