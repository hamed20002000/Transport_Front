...
import { Typography, Box, Stack, Grid, Button, Alert, CircularProgress, TextField, Autocomplete, RadioGroup, FormControlLabel, Radio, FormControl, FormLabel, Paper, Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions, Chip, IconButton, List, ListItem, ListItemButton, ListItemText, keyframes, styled } from 'src/shared/components/compat';
...
import RegisterUnregisteredItemModal, { RegisterItemInitialData } from 'src/features/tenders/pages/RegisterUnregisteredItemModal';
import { ApiItemType } from 'src/features/tenders/pages/TenderDetails';
import NetworkItemInputForm, { AvailableItemOption } from 'src/features/operations/pages/list-network/NetworkItemInputForm';
import NetworkDetailsTable from 'src/features/operations/pages/list-network/NetworkDetailsTable';
