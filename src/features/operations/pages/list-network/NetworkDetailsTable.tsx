...
import { TableContainer, Table, TableHead, TableRow, TableCell, TableBody, Typography, Box, IconButton, TablePagination, Collapse, Stack, TextField } from 'src/shared/components/compat';
import {
    IconCirclePlus, IconCircleMinus,
    IconChevronRight, IconChevronDown,
    IconEdit, IconTrash, IconCheck, IconX
} from '@tabler/icons-react';
import { WorkDetailSubEntry, WorkDetailRow } from 'src/features/operations/pages/list-network/NetworkDetails';
