...
import { TableContainer, Table, TableHead, TableRow, TableBody, TableCell as UiTableCell, MenuItem as UiMenuItem, Typography, Chip, Box, Stack, Grid, Button, Alert, TablePagination, TextField, InputAdornment, CircularProgress, ToggleButtonGroup, ToggleButton as UiToggleButton, Menu, IconButton, ListItemIcon, Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions, FormControl, Select } from 'src/shared/components/compat';
...
import DeleteNetwork from 'src/features/operations/pages/list-network/DeleteNetwork';

import { tr } from 'date-fns/locale';
import { format } from 'date-fns';

import { useAuth } from 'src/core/auth/AuthContext';
import { SelectChangeEvent } from 'src/shared/components/compat';
                            ...
                            {workId === undefined && (
                                <Grid item xs={12} sm={6}>
                                    ...
                                    <FormControl fullWidth size="small">
                                        ...
                                        >
                                            {works.map((work) => (
                                                <UiMenuItem key={work.id} value={work.id}>
                                                    {work.title}
                                                </UiMenuItem>
                                            ))}
                                        </Select>
                                                ...
                                                <StyledTableCell>
                                                    ...
                                                    >
                                                        {hasEditPermission && (
                                                            ...
                                                            >
                                                                <UiMenuItem onClick={handleDefineTransmission}>
                                                                    <ListItemIcon>
                                                                        <IconPlus width={18} />
                                                                    </ListItemIcon>
                                                                    İletken İcmali
                                                        ...
                                                        {hasEditPermission && (
                                                            ...
                                                            >
                                                                <UiMenuItem onClick={selectedRowForMenu?.recordStatus === 0 ? handleSetInactive : handleSetActive}>
                                                                    <ListItemIcon>
