...
import { TableContainer, Table, TableHead, TableRow, TableBody, TableCell as UiTableCell, MenuItem as UiMenuItem, Typography, Chip, Menu, IconButton, Box, Stack, Grid, Button, Alert, TablePagination, TextField, InputAdornment, CircularProgress, TableSortLabel, Autocomplete, ToggleButtonGroup, ToggleButton as UiToggleButton, ListItemIcon, Paper, Dialog, DialogTitle, DialogContent, DialogActions } from 'src/shared/components/compat';
...
import DeleteWork from 'src/features/operations/pages/list-work/DeleteWork';
                                                ...
                                                >
                                                    ...
                                                    {hasCreatePermission && (
                                                        <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu iş için yeni bir şantiye kaydı oluştur" : ""}>
                                                            <UiMenuItem onClick={handleGoToWorkhouses}>
                                                                <ListItemIcon>
                                                                    <IconPlus width={18} />
                                                                </ListItemIcon>
                                                                Şantiye Ekle
