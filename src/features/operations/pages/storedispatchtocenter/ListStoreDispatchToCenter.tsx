...
import DeleteStoreDispatchToCenter from "src/features/operations/pages/storedispatchtocenter/DeleteStoreDispatchToCenter";
                                                        ...
                                                        >
                                                            ...
                                                            {hasApproveRejectPermission && (
                                                                <>
                                                                    {row.status === 0 && (
                                                                        <>
                                                                            <UiMenuItem onClick={() => handleStatusUpdateClick('approve')}>
                                                                                <ListItemIcon><IconCheck width={18} /></ListItemIcon>Onayla
                                                                            </UiMenuItem>
                                                                            <UiMenuItem onClick={() => handleStatusUpdateClick('reject')}>
