...
import { Box, Divider, Fab, TextField, FormLabel, useTheme, IconButton, Typography } from 'src/shared/components/compat';
import { IconCheck, IconMenu2 } from '@tabler/icons-react';

import { UpdateNote } from 'src/features/notes/model/NotesSlice';
import AddNotes from 'src/features/notes/components/AddNotes';
import { NotesType } from 'src/features/notes/types';
