...
import { addNote } from 'src/features/notes/model/NotesSlice';
import { Button, Dialog, Fab, DialogContent, TextField, DialogActions, DialogContentText, Typography } from 'src/shared/components/compat';
