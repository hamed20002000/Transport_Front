...
import { TableContainer, Table, TableHead, TableRow, TableBody, TableCell as UiTableCell, MenuItem as UiMenuItem, Typography, Chip, Menu, IconButton, ListItemIcon, Box, Stack, Grid, Alert, TablePagination, TextField, InputAdornment, ToggleButtonGroup, ToggleButton as UiToggleButton, TableSortLabel, Dialog, DialogTitle, DialogContent, DialogActions, Button, Paper, CircularProgress, Autocomplete, DialogContentText, Divider } from 'src/shared/components/compat';
import { keyframes, styled } from 'src/shared/components/compat';
import { LocalizationProvider, DatePicker } from 'src/shared/components/compat';
...
import OrderItemsTable from 'src/features/orders/pages/OrderItemsTable';
...
import DeleteOrderModal from 'src/features/orders/pages/DeleteOrderModal';
import RegisterUnregisteredItemModal from 'src/features/tenders/pages/RegisterUnregisteredItemModal';
import SelectTenderItemsModal from 'src/features/orders/pages/SelectTenderItemsModal';
                                                ...
                                                >
                                                    {hasStatusPermission && selectedOrderForMenu?.status === 0 && (
                                                        <>
                                                            <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu siparişi onaylayın" : ""}>
                                                                <UiMenuItem onClick={() => handleClickOpenStatusModal(row.id, 'approve')}>
                                                            ...
                                                            <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu siparişi reddedin" : ""}>
                                                                <UiMenuItem onClick={() => handleClickOpenStatusModal(row.id, 'reject')}>
                                                    ...
                                                    {hasEditPermission && selectedOrderForMenu?.status === 0 && (
                                                        <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu siparişi düzenleyin" : ""}>
                                                            <UiMenuItem onClick={() => handleEditClick(row)}>
                                                    ...
                                                    {hasDeletePermission && selectedOrderForMenu?.status === 0 && (
                                                        <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu siparişi silin" : ""}>
                                                            <UiMenuItem onClick={() => handleClickOpenDeleteModal(row.id, row.network.title)}>
