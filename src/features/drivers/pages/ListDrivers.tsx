...
import { RadioGroup, FormControlLabel, Radio } from 'src/shared/components/compat';
import DeleteDriver from "src/features/drivers/pages/DeleteDriver";
import CarDetailsModal from "src/features/drivers/pages/CarDetailsModal";
                                                ...
                                                >
                                                    {hasCreatePermission && (
                                                        <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Sürücü için araç detaylarını kaydet" : ""}>
                                                            <UiMenuItem onClick={() => { handleClickOpenCarDetailsModal(selectedRowForMenu!); handleCloseMenu(); }}>
                                                                <ListItemIcon><IconPlus width={18} /></ListItemIcon>Ayrıntıları Kaydet
                                                            </UiMenuItem>
                                                        </CustomTooltip>
                                                    )}
                                                    {hasDownloadPermission && (
                                                        <UiMenuItem onClick={() => { setSelectedDriver(selectedRowForMenu); setOpenDriverDetailsDownloadModal(true); handleCloseMenu(); }}>
