...
import { Dialog, DialogTitle, DialogContent, DialogActions, Button, Stack, Grid, CircularProgress, Typography, Box, TableCell as UiTableCell, MenuItem as UiMenuItem, Paper, TableContainer, Table, TableHead, TableRow, TableBody, Chip, IconButton, Menu, ListItemIcon, Alert, styled } from 'src/shared/components/compat';
...
import DeleteVehicle from 'src/features/drivers/pages/DeleteVehicle';
                                        ...
                                        <TableRow key={row.id}>
                                            ...
                                            <StyledTableCell>
                                                ...
                                                >
                                                    ...
                                                    <UiMenuItem onClick={() => handleDeleteClick(row)}>
                                                        <ListItemIcon><IconTrash width={18} /></ListItemIcon> Silmek
                                                    </UiMenuItem>
                                                    {row.recordStatus === 0 ? (
                                                        <UiMenuItem onClick={() => handleUpdateStatus(row.id, 1)}>
                                                            <ListItemIcon><DoNotDisturbOnRoundedIcon width={18} /></ListItemIcon> Pasif Yap
                                                        </UiMenuItem>
                                                    ) : (
                                                        <UiMenuItem onClick={() => handleUpdateStatus(row.id, 0)}>
