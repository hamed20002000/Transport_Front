import { Box, Stack, Grid, Typography, Chip, TextField, InputAdornment, IconButton, CardMedia, Skeleton } from 'src/shared/components/compat';
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore
import React, { useEffect } from 'react';
import BlankCard from 'src/shared/components/BlankCard';
import { useSelector, useDispatch } from 'src/app/store';
import { fetchPhotos } from 'src/features/profile/model/UserProfileSlice';
import { IconDotsVertical, IconSearch } from '@tabler/icons-react';
import { format } from 'date-fns';
import { GallaryType } from 'src/shared/types/apps/users';
