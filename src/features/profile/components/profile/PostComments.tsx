...
import { Stack, Avatar, Box, Typography, Tooltip, Fab, TextField, Button } from 'src/shared/components/compat';
import { IconArrowBackUp, IconCircle, IconThumbUp } from '@tabler/icons-react';

import { useDispatch } from 'src/app/store';
import uniqueId from 'lodash/uniqueId';
import { addReply } from 'src/features/profile/model/UserProfileSlice';
import {
  PostType,
