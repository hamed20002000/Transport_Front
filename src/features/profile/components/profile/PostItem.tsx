...
import { Stack, Avatar, Box, Typography, CardMedia, Grid, IconButton, Fab, Tooltip, TextField, Button, Divider } from 'src/shared/components/compat';
import { IconCircle, IconMessage2, IconShare, IconThumbUp } from '@tabler/icons-react';
import uniqueId from 'lodash/uniqueId';
import { useDispatch, useSelector } from 'src/app/store';
import { likePosts, addComment } from 'src/features/profile/model/UserProfileSlice';
import PostComments from 'src/features/profile/components/profile/PostComments';
import BlankCard from 'src/shared/components/BlankCard';
import { Comment as CommentType, PostType } from 'src/features/profile/types';
