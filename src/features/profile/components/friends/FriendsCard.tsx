import { CardContent, Box, Stack, Avatar, Grid, Typography, Chip, TextField, InputAdornment, Divider, IconButton } from 'src/shared/components/compat';
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore
import React, { useEffect } from 'react';
import BlankCard from 'src/shared/components/BlankCard';
import { useSelector, useDispatch } from 'src/app/store';
import { fetchFollwores } from 'src/features/profile/model/UserProfileSlice';
import {
  IconBrandFacebook,
  IconBrandGithub,
  IconBrandInstagram,
