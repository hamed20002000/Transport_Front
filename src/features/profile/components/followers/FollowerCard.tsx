import { CardContent, Box, Stack, Avatar, Grid, Button, Typography, Chip, TextField, InputAdornment } from 'src/shared/components/compat';
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore
import React, { useEffect } from 'react';
import BlankCard from 'src/shared/components/BlankCard';
import { useSelector, useDispatch } from 'src/app/store';
import { fetchFollwores, onToggleFollow } from 'src/features/profile/model/UserProfileSlice';
import { IconMapPin, IconSearch } from '@tabler/icons-react';
import { userType } from 'src/shared/types/apps/users';
