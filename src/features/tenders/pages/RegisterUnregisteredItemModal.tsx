...
import { Dialog, DialogTitle, DialogContent, DialogActions, Button, Stack, Grid, CircularProgress, FormControl, InputLabel, Select, TextField, InputAdornment, MenuItem as UiMenuItem, Typography, Checkbox, ListItemIcon, ListItemText, Box, List, IconButton, Tooltip } from 'src/shared/components/compat';
                                ...
                                >
                                    ...
                                    {loadingUnits ? (
                                        ...
                                        unitOptions.filter(unit => unit.title.toLowerCase().includes(unitSearchTerm.toLowerCase())).map((unit) => (
                                            <UiMenuItem key={unit.id} value={unit.id}>{unit.title}</UiMenuItem>
                                        ))
                                    ) : (
