...
import { Dialog, DialogTitle, DialogContent, DialogActions, Button, Stack, Grid, CircularProgress, FormControl, InputLabel, Select, TextField, InputAdornment, MenuItem as UiMenuItem, Typography, Checkbox, ListItemIcon, ListItemText, Box, IconButton, List } from 'src/shared/components/compat';
...
import { ApiCategoryType } from 'src/features/tenders/pages/TenderDetails';
                    ...
                    <Grid item xs={12}>
                        ...
                        <FormControl fullWidth error={parentCategoryIdError}>
                            ...
                            >
                                ...
                                />
                                <UiMenuItem value={""} onClick={() => handleToggleParentCategorySelection("", true)}>
                                ...
                                {loadingCategories ? (
                                    ...
                                    <UiMenuItem disabled>Hiç üst kategori bulunamadı.</UiMenuItem>
                                )}
                            </Select>
