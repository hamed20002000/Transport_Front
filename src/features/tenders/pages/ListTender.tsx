...
import { TableContainer, Table, TableHead, TableRow, TableBody, TableCell as UiTableCell, MenuItem as UiMenuItem, Typography, Chip, Menu, IconButton, ListItemIcon, Box, Stack, Grid, Button, Alert, TablePagination, TextField, InputAdornment, ToggleButtonGroup, ToggleButton as UiToggleButton, CircularProgress, TableSortLabel } from 'src/shared/components/compat';
...
import DeleteTender from 'src/features/tenders/pages/DeleteTender';
import DefineWorkModal from 'src/features/tenders/pages/DefineWorkModal';
...
import { AssignmentTurnedIn as AssignmentTurnedInIcon } from 'src/shared/components/compat/icons';
import { ThumbUpAlt as ThumbUpAltIcon } from 'src/shared/components/compat/icons';
import { ThumbDownAlt as ThumbDownAltIcon } from 'src/shared/components/compat/icons';

import Excel from 'exceljs';
import AttachFileModal from 'src/features/tenders/pages/AttachFileModal';
import DownloadAttachmentsModal from 'src/features/tenders/pages/DownloadAttachmentsModal';

import DownloadOptionsModal from 'src/features/tenders/pages/DownloadOptionsModal';
...
import { useDomainRefresh } from "src/features/ai-agent/hooks/Usedomainrefres";
                        ...
                        >
                          {hasDownloadPermission && selectedRowForMenu?.attachments && selectedRowForMenu.attachments.length > 0 && (
                            <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Ek dosyaları indir" : ""}>
                              <UiMenuItem onClick={handleDownloadAttachments}>
                                <ListItemIcon>
                          ...
                          {hasDownloadPermission && (
                            <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Satın alma için ihale verilerini indir" : ""}>
                              <UiMenuItem onClick={handleDownloadTenderForPurchase}>
                                <ListItemIcon>
                                  <IconDownload size={18} />
                                </ListItemIcon>
                          ...
                          {hasStatusPermission && selectedRowForMenu?.tenderStatus === 0 && (
                            <>
                              <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu ihaleyi onayla" : ""}>
                                <UiMenuItem onClick={handleSetActiveTender}>
                                  <ListItemIcon>
                              ...
                              <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu ihaleyi reddet" : ""}>
                                <UiMenuItem onClick={handleSetInactiveTender}>
                                  <ListItemIcon>
                          ...
                          {hasStatusPermission && selectedRowForMenu?.tenderStatus === 1 && (
                            <>
                              ...
                              <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "İş tanımla" : ""}>
                                <UiMenuItem onClick={() => handleDefineWork(selectedRowForMenu.id)}>
                                  <ListItemIcon>
                              ...
                              <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "İhaleye ek dosyalar ekle" : ""}>
                                <UiMenuItem onClick={handleClickOpenAttachModal}>
                                  <ListItemIcon>
                          ...
                          {hasEditPermission && selectedRowForMenu?.recordStatus === 0 ? (
                            <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu ihaleyi pasif yap" : ""}>
                              <UiMenuItem onClick={handleSetInactive}>
                                <ListItemIcon>
                            ...
                            <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu ihaleyi aktif yap" : ""}>
                              <UiMenuItem onClick={handleSetActive}>
                                <ListItemIcon>
                          ...
                          {hasEditPermission && (
                            <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu ihaleyi düzenle" : ""}>
                              <UiMenuItem onClick={handleEditClick}>
                                <ListItemIcon>
                                  <IconEdit width={18} />
                                </ListItemIcon>
                                Düzenlemek
                          ...
                          {hasDeletePermission && (
                            <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu ihaleyi sil" : ""}>
                              <UiMenuItem onClick={handleClickOpenDeleteModal}>
                                <ListItemIcon>
                                  <IconTrash width={18} />
                                </ListItemIcon>
                                Silmek
