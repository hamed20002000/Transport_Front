...
import { Box, Typography, Grid, Button, Alert, Stack, CircularProgress, Paper, TextField, InputAdornment, FormControl, Select, MenuItem as UiMenuItem, TableContainer, Table, TableHead, TableRow, TableCell, TableBody, IconButton, List, Checkbox, ListItemText, Backdrop, Chip, DialogContent, Dialog, DialogTitle, DialogActions } from 'src/shared/components/compat';
...
import "src/features/tenders/pages/style.css"
...
import RegisterUnregisteredCategoryModal from 'src/features/tenders/pages/RegisterUnregisteredCategoryModal';
import { RegisterItemInitialData } from 'src/features/tenders/pages/RegisterUnregisteredItemModal';
import { RegisterCategoryInitialData } from 'src/features/tenders/pages/RegisterUnregisteredCategoryModal';

import { keyframes } from 'src/shared/components/compat';
                                    ...
                                    <TableCell sx={{ backgroundColor: 'inherit', borderRight: '1px solid ' + theme.palette.divider }}>
                                        <FormControl fullWidth size="small" variant="outlined">
                                            ...
                                            >
                                                ...
                                                {loadingTree ? (
                                                    <UiMenuItem disabled><CircularProgress size={20} sx={{ mr: 1 }} /> Yükleniyor...</UiMenuItem>
                                                ) : (
                                                    <List component="div" disablePadding>
