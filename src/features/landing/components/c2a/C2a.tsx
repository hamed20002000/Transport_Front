...
import { CardContent, Grid, Typography, Box, styled, Button, Container, Stack } from 'src/shared/components/compat';
...
import bannerbgImg from 'src/shared/assets/images/landingpage/shape/line-bg.svg';
