...
import { Box, Typography, Grid, Button, Alert, Stack, CircularProgress, FormControl, RadioGroup, FormControlLabel, Radio, Select, MenuItem as UiMenuItem, Checkbox, FormGroup, Card, CardContent, Divider } from 'src/shared/components/compat';
import { styled } from 'src/shared/components/compat';
import { Bolt as BoltIcon } from 'src/shared/components/compat/icons';
import { CheckCircleOutline as CheckCircleOutlineIcon } from 'src/shared/components/compat/icons';
import { HighlightOff as HighlightOffIcon } from 'src/shared/components/compat/icons';
            ...
            <Grid item xs={12} sm={6} md={4}>
              <Stack direction="row" spacing={1} alignItems="center">
                ...
                <Select
                  ...
                  displayEmpty
                >
                  <UiMenuItem value="" disabled>Rol Seçiniz</UiMenuItem>
                  {rolesList.map((role) => (
                    <UiMenuItem key={role.id} value={role.id}>{role.name}</UiMenuItem>
                  ))}
                </Select>
              </Stack>
            </Grid>
            ...
            <Grid item xs={12} sm={6} md={4}>
              <Stack direction="row" spacing={1} alignItems="center">
                ...
                <Select
                  ...
                  displayEmpty
                >
                  <UiMenuItem value="" disabled>Kullanıcı Seçiniz</UiMenuItem>
                  {usersList.map((user) => (
                    <UiMenuItem key={user.id} value={user.id}>{user.username}</UiMenuItem>
                  ))}
                </Select>
              </Stack>
            </Grid>
