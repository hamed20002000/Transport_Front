...
import { Box, Button, TextField, Typography, Avatar, Divider, IconButton, Stack, Grid, Tooltip, useTheme } from 'src/shared/components/compat';
import {
  isEdit,
  UpdateContact,
  DeleteContact,
...
import { ContactType } from 'src/shared/types/apps/contact';
