...
import { Box, Stack, Grid, Paper, Typography, Button, CircularProgress, ToggleButtonGroup, ToggleButton, Chip, IconButton, Alert, TextField, Autocomplete, LinearProgress, Avatar, Divider, TableContainer, Table, TableHead, TableRow, TableCell, TableBody, Collapse } from 'src/shared/components/compat';
...
import { ExpandMore as ExpandMoreIcon } from 'src/shared/components/compat/icons';
import { ExpandLess as ExpandLessIcon } from 'src/shared/components/compat/icons';
...
import { blue, green, orange, red } from 'src/shared/components/compat/colors';
                                    ...
                                    <Grid item xs={12} md={6} key={key}>
                                        <FancyCard>
                                            <Stack spacing={2}>
                                                ...
                                                <LinearProgress variant="determinate" value={prog.overall} sx={{ height: 6, borderRadius: 5, "& .UiLinearProgress-bar": { bgcolor: getStatusColor(prog.overall) } }} />
