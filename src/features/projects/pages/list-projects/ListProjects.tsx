...
import { TableContainer, Table, TableHead, TableRow, TableBody, TableCell as UiTableCell, MenuItem as UiMenuItem, Stack, Grid, Button, Alert, TablePagination, TextField, InputAdornment, ToggleButton as UiToggleButton, CircularProgress, Paper, ToggleButtonGroup, RadioGroup, FormControlLabel, Radio, TableSortLabel, Autocomplete, Dialog, DialogTitle, DialogContent, DialogActions, Typography, IconButton, Box, Chip, Menu, ListItemIcon } from 'src/shared/components/compat';
...
import ProjectFirmManagement from 'src/features/projects/pages/list-projects/ProjectFirmManagement';
import DeleteProject from 'src/features/projects/pages/list-projects/DeleteProject';
                                            ...
                                            <StyledTableCell>
                                                ...
                                                <Menu anchorEl={anchorEl} open={Boolean(anchorEl) && selectedRowForMenu?.id === row.id} onClose={handleCloseMenu}>
                                                    <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Proje için planlama sayfasına git" : ""}>
                                                        <UiMenuItem onClick={handlePlanlamaClick}>
                                                    ...
                                                    {hasEditPermission && (
                                                        <UiMenuItem onClick={handleEditClick}><ListItemIcon><IconEdit width={18} /></ListItemIcon> Düzenle</UiMenuItem>
                                                    )}
                                                    {hasDeletePermission && (
