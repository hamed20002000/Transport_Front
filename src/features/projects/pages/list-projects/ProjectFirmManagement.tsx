...
import { Dialog, DialogTitle, DialogContent, DialogActions, TextField, Button, TableContainer, Table, TableHead, TableRow, TableCell, TableBody, CircularProgress, IconButton, Stack, Box, Typography, Paper, Grid, Chip, Menu, MenuItem, ListItemIcon, Alert } from 'src/shared/components/compat';
...
import DeleteFirm from 'src/features/projects/pages/list-projects/DeleteFirm';
