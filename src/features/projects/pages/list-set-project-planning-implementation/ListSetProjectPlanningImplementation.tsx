...
import { TableContainer, Table, TableHead, TableRow, TableBody, Typography, Chip, Menu, IconButton, ListItemIcon, Box, TableCell as UiTableCell, MenuItem as UiMenuItem, Stack, Grid, Button, Alert, TablePagination, TextField, InputAdornment, ToggleButtonGroup, ToggleButton as UiToggleButton, TableSortLabel, Dialog, DialogTitle, DialogContent, DialogActions, CircularProgress, FormControl, Autocomplete, DialogContentText } from 'src/shared/components/compat';
...
import "src/features/projects/pages/list-set-project-planning-implementation/style.css"
import DeleteSetProjectPlanningImplementation from 'src/features/projects/pages/list-set-project-planning-implementation/DeleteSetProjectPlanningImplementation';
...
const StatusToggleButton = styled(UiToggleButton)<{ value: number, selected: boolean }>(({ theme, value, selected }) => ({
    width: '33%',
    fontSize: '0.7rem',
    padding: '4px 8px',
                                            ...
                                            <Menu anchorEl={anchorEl} open={openMenu && selectedRowForMenu?.id === row.id} onClose={handleCloseMenu}>
                                                ...
                                                {hasDownloadPermission && (
                                                    <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu uygulamayı indir" : ""}>
                                                        <UiMenuItem onClick={() => { setOpenSingleDownloadModal(true); }}>
