...
import { TableContainer, Table, TableHead, TableRow, TableBody, Typography, TableCell as UiTableCell, MenuItem as UiMenuItem, Chip, Menu, IconButton, ListItemIcon, Box, Stack, Grid, Button, Alert, TablePagination, TextField, InputAdornment, CircularProgress, Paper, ToggleButtonGroup, ToggleButton as UiToggleButton, TableSortLabel, Dialog, DialogTitle, DialogContent, DialogActions } from 'src/shared/components/compat';
...
import DeleteRegion from 'src/features/reference-data/pages/region/DeleteRegion';
