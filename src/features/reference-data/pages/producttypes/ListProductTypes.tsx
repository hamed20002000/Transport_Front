...
import DeleteProductTypes from 'src/features/reference-data/pages/producttypes/DeleteProductType';
...
const ListProductTypes = () => {
    const navigate = useNavigate();
        useDomainRefresh("product_type",()=>{handleRefreshAI();})
