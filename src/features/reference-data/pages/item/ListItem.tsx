...
import { TableContainer, Table, TableHead, TableRow, TableCell as UiTableCell, TableBody, Typography, Chip, Menu, IconButton, ListItemIcon, Box, Stack, Grid, Button, Alert, Checkbox, InputAdornment, TablePagination, TextField, CircularProgress, FormControl, InputLabel, Select, MenuItem as UiMenuItem, ToggleButtonGroup, ToggleButton as UiToggleButton, Dialog, DialogTitle, DialogContent, DialogContentText, DialogActions, List, ListItemText, TableSortLabel } from 'src/shared/components/compat';
...
import DeleteItem from 'src/features/reference-data/pages/item/DeleteItem';
                ...
                >
                  ...
                  {loadingUnits ? (
                    ...
                    filteredUnitOptions.map((unit) => (
                      <UiMenuItem key={unit.id} value={unit.id}>
                        {unit.title}
                      </UiMenuItem>
                    ))
                  ) : (
                    <UiMenuItem disabled>Hiç birim bulunamadı.</UiMenuItem>
                  )}
                </Select>
              ...
              <FormControl fullWidth error={categoryIdError}>
                ...
                >
                  ...
                  {loadingCategories ? (
                    ...
                    <UiMenuItem disabled>Hiç kategori bulunamadı.</UiMenuItem>
                  )}
                </Select>
