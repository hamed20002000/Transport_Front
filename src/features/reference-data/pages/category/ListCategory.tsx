...
import { TableContainer, Table, TableHead, TableRow, TableCell as UiTableCell, MenuItem as UiMenuItem, TableBody, Typography, Chip, Menu, IconButton, ListItemIcon, Box, Stack, Grid, Button, Alert, TablePagination, TextField, InputAdornment, CircularProgress, Paper, ToggleButtonGroup, ToggleButton as UiToggleButton, TableSortLabel, Dialog, DialogTitle, DialogContent, DialogActions } from 'src/shared/components/compat';
...
import DeleteCategory from 'src/features/reference-data/pages/category/DeleteCategory';
