...
import { Box, Table, TableHead, TableRow, TableCell, Typography, TableBody, IconButton, Chip, Stack, Avatar, Tooltip, TextField, Pagination, useTheme, TableContainer } from 'src/shared/components/compat';
import { fetchTickets, DeleteTicket, SearchTicket } from 'src/features/tickets/model/TicketSlice';
