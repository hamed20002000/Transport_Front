...
import { TableContainer, Table, TableHead, TableRow, TableBody, TableCell as UiTableCell, Typography, Chip, Menu, IconButton, Box, Stack, Grid, Button, Alert, TablePagination, TextField, InputAdornment, CircularProgress, Paper, ToggleButtonGroup, ToggleButton as UiToggleButton, TableSortLabel, MenuItem as UiMenuItem, Dialog, DialogTitle, DialogContent, DialogActions, DialogContentText, Autocomplete, ListItemIcon } from 'src/shared/components/compat';
...
import DeleteCourses from 'src/features/education/pages/courses/DeleteCourses';
import ListCourseDateTimes from 'src/features/education/pages/course-date-times/ListCourseDateTimes';
import ListCourseParticipants from 'src/features/education/pages/course-participants/ListCourseParticipants';
                                        ...
                                        >
                                            ...
                                            <StyledTableCell>
                                                ...
                                                <Menu anchorEl={anchorEl} open={Boolean(anchorEl) && selectedRowForMenu?.id === row.id} onClose={handleCloseMenu}>
                                                    ...
                                                    >
                                                        <UiMenuItem onClick={() => handleOpenDateTimesModal(selectedRowForMenu!)}>
                                                    ...
                                                    >
                                                        <UiMenuItem onClick={() => handleOpenParticipantsModal(selectedRowForMenu!)}>
                                                    ...
                                                    {hasEditPermission && (<UiMenuItem onClick={() => handleEditClick(selectedRowForMenu!)}><ListItemIcon><IconEdit width={18} /></ListItemIcon>Düzenle</UiMenuItem>)}
                                                    {hasEditPermission && (
                                                        selectedRowForMenu?.recordStatus === 0 ? (
                                                            <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu kursu pasif yap" : ""}>
                                                                <UiMenuItem onClick={() => sendStatusUpdate(row.id, 1)}><ListItemIcon><DoNotDisturbOnRoundedIcon width={18} /></ListItemIcon> Pasif Yap</UiMenuItem>
                                                            </CustomTooltip>
                                                        ) : (
                                                            <CustomTooltip placement="left" title={isTooltipGloballyEnabled ? "Bu kursu aktif yap" : ""}>
                                                                <UiMenuItem onClick={() => sendStatusUpdate(row.id, 0)}><ListItemIcon><DoneRoundedIcon width={18} /></ListItemIcon> Aktif Yap</UiMenuItem>
                                                            </CustomTooltip>
                                                        )
                                                    )}
                                                    {hasDeletePermission && (<UiMenuItem onClick={handleClickOpenDeleteModal}><ListItemIcon><IconTrash width={18} /></ListItemIcon>Silmek</UiMenuItem>)}
                                                    {hasDownloadPermission && (<UiMenuItem onClick={() => handleOpenRowDownloadModal(row)}><ListItemIcon><IconFileDownload width={18} /></ListItemIcon>Bu satırı indir</UiMenuItem>)}
                                                </Menu>
                                            </StyledTableCell>
                                        </TableRow>
                                    ))
