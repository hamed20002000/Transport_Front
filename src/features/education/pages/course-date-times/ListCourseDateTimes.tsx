...
import { Button, Dialog, DialogTitle, DialogContent, DialogActions, Table, TableHead, TableBody, TableRow, TableCell, CircularProgress, Box, Stack, Grid, IconButton, Menu, MenuItem, Typography, TableSortLabel, TablePagination, TableContainer, Paper, TextField, ListItemIcon, Alert } from 'src/shared/components/compat';

import { DateTimePicker, LocalizationProvider } from 'src/shared/components/compat';
...
import DeleteCourseDateTimes from 'src/features/education/pages/course-date-times/DeleteCourseDateTimes';
