...
import { Button, Dialog, DialogTitle, DialogContent, DialogActions, Table, TableHead, TableBody, TableRow, TableCell, CircularProgress, Box, Stack, Grid, IconButton, Menu, MenuItem, Typography, Autocomplete, TextField, TablePagination, Chip, ListItemIcon, TableContainer, TableSortLabel, Alert, Tabs, Tab } from 'src/shared/components/compat';
...
import DeleteCourseParticipants from 'src/features/education/pages/course-participants/DeleteCourseParticipants';
