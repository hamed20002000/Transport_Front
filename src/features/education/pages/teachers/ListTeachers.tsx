...
import { TableContainer, Table, TableHead, TableRow, TableBody, TableCell as UiTableCell, Typography, Chip, Menu, IconButton, ListItemIcon, Box, Stack, Grid, Button, Alert, TablePagination, TextField, InputAdornment, CircularProgress, Paper, TableSortLabel, MenuItem as UiMenuItem, Dialog, DialogTitle, DialogContent, DialogActions, ToggleButtonGroup, ToggleButton as UiToggleButton } from 'src/shared/components/compat';
...
import { styled, keyframes } from 'src/shared/components/compat';
...
import DeleteTeachers from 'src/features/education/pages/teachers/DeleteTeachers';
                                        ...
                                        <TableRow key={row.id}>
                                            ...
                                            <StyledTableCell>
                                                ...
                                                <Menu anchorEl={anchorEl} open={Boolean(anchorEl) && selectedRowForMenu?.id === row.id} onClose={handleCloseMenu}>
                                                    {hasEditPermission && (<UiMenuItem onClick={() => handleEditClick(row)}><ListItemIcon><IconEdit width={18} /></ListItemIcon>Düzenle</UiMenuItem>)}
                                                    {hasEditPermission && (
