import { Box, Container, Typography, Button } from 'src/shared/components/compat';
import { Link } from 'react-router-dom';
import MaintenanceImg from 'src/shared/assets/images/backgrounds/maintenance.svg';
