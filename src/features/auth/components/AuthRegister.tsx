...
import { Box, Typography, Button, Divider, Stack } from 'src/shared/components/compat';
...
import { registerType } from 'src/core/auth/types/auth';
import AuthSocialButtons from 'src/features/auth/components/AuthSocialButtons';
