...
import { Typography, Divider, Avatar, ListItem, ListItemText, ListItemAvatar, IconButton, Box, Stack, Badge, useMediaQuery, Theme } from 'src/shared/components/compat';
...
import ChatInsideSidebar from 'src/features/chat/components/ChatInsideSidebar';
