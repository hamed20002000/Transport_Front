...
import { TableContainer, Table, TableHead, TableRow, TableBody, TableCell as UiTableCell, Typography, Chip, Menu, IconButton, ListItemIcon, Box, Stack, Grid, Button, Alert, TablePagination, TextField, InputAdornment, CircularProgress, Paper, Autocomplete, Dialog, DialogTitle, DialogContent, DialogActions, DialogContentText, TableSortLabel, MenuItem as UiMenuItem } from 'src/shared/components/compat';

import {
    IconDots, IconTrash, IconSearch, IconFileDownload, IconX,
    IconFileSpreadsheet, IconFileText, IconBox, IconLink, IconGasStation
} from '@tabler/icons-react';
import { DirectionsCarFilledRounded as DirectionsCarFilledRoundedIcon } from 'src/shared/components/compat/icons';
...
import DeleteConsignedCarwarehouse from 'src/features/vehicles/pages/consigned-carwarehouse/DeleteConsignedCarwarehouse';
                                        ...
                                        <TableRow key={row.id}>
                                            ...
                                            <StyledTableCell>
                                                ...
                                                <Menu anchorEl={anchorEl} open={Boolean(anchorEl) && selectedRowForMenu?.id === row.id} onClose={handleCloseMenu}>
                                                    {row.consigned && hasCreatePermission && (<UiMenuItem onClick={() => handleReturnCar(row)}><ListItemIcon><DirectionsCarFilledRoundedIcon fontSize="small" /></ListItemIcon> Geri Al</UiMenuItem>)}

                                                    {hasCreatePermission && (
                                                        <UiMenuItem onClick={() => handleRegisterFuel(row)}>
                                                    ...
                                                    {hasDownloadPermission && (
                                                        <UiMenuItem onClick={() => handleOpenRowDownloadModal(row)}>
                                                            ...
                                                            </ListItemIcon>Bu satırı indir</UiMenuItem>
                                                    )}
