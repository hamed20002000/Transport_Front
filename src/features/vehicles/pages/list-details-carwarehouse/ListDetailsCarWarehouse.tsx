...
import { TableContainer, Table, TableHead, TableRow, TableBody, TableCell as UiTableCell, Typography, Chip, Menu, IconButton, ListItemIcon, Box, Stack, Grid, Button, Alert, TablePagination, TextField, InputAdornment, CircularProgress, Paper, ToggleButtonGroup, ToggleButton as UiToggleButton, TableSortLabel, MenuItem as UiMenuItem, Dialog, DialogTitle, DialogContent, DialogActions, DialogContentText, Autocomplete, TableCell, Tabs, Tab } from 'src/shared/components/compat';

import "src/features/vehicles/pages/list-details-carwarehouse/style.css"
...
import DeleteDetailsCarWarehouse from 'src/features/vehicles/pages/list-details-carwarehouse/DeleteDetailsCarWarehouse';
...
const StyledToggleButton = styled(UiToggleButton)(({ theme }) => ({
    ...
    "&.Ui-selected[data-value='all']": {
        backgroundColor: theme.palette.primary.main,
        "&:hover": { backgroundColor: theme.palette.primary.dark },
    },
    "&.Ui-selected[data-value='active']": {
        backgroundColor: theme.palette.success.main,
        "&:hover": { backgroundColor: theme.palette.success.dark },
    },
    "&.Ui-selected[data-value='inactive']": {
