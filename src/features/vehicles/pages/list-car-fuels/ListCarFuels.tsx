...
import { TableContainer, Table, TableHead, TableRow, TableBody, TableCell as UiTableCell, Typography, Chip, Menu, IconButton, ListItemIcon, Box, Stack, Grid, Button, Alert, TablePagination, TextField, InputAdornment, CircularProgress, Paper, Dialog, DialogTitle, DialogContent, DialogActions, DialogContentText, TableSortLabel, MenuItem as UiMenuItem, Select, FormControl, InputLabel, Divider } from 'src/shared/components/compat';
...
import DeleteCarFuels from 'src/features/vehicles/pages/list-car-fuels/DeleteCarFuels';
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} sm={6} md={4}>
                                ...
                                <TextField
                                    ...
                                    sx={{ "& .UiInputBase-input.Ui-disabled": { WebkitTextFillColor: "#000", fontWeight: "bold" } }}
                                />
                            </Grid>
                                        ...
                                        <TableRow key={row.id}>
                                            ...
                                            <StyledTableCell>
                                                ...
                                                <Menu anchorEl={anchorEl} open={Boolean(anchorEl) && selectedRowForMenu?.id === row.id} onClose={handleCloseMenu}>
                                                    {hasEditPermission && (<UiMenuItem onClick={() => handleEdit(row)}><ListItemIcon><IconEdit width={18} /></ListItemIcon>Düzenle</UiMenuItem>)}
                                                    ...
                                                    {hasDownloadPermission && (
                                                        <UiMenuItem onClick={() => handleOpenRowDownloadMenu(row)}>
