...
import { ListItemIcon, styled, ListItemText, ListItemButton, Collapse, List } from 'src/shared/components/compat';
...
import { MenuitemsType } from 'src/app/layouts/full/horizontal/navbar/Menudata';
...
const NavCollapse = ({ menu, level, pathWithoutLastPart, pathDirect, hideMenu, onClick }: NavCollapseProps) => {
  ...
  const ListItemStyled = styled(ListItemButton)(() => ({
    ...
    [`&.Ui-selected[data-level="1"]`]: {
      color: 'white!important',
      backgroundColor: theme.palette.primary.main,
    },
    [`&.Ui-selected[data-level="2"]`]: {
