...
import { Dialog, DialogTitle, DialogContent, DialogActions, Button, Box, Typography, CircularProgress, FormControl, InputLabel, Select, MenuItem } from 'src/shared/components/compat';
