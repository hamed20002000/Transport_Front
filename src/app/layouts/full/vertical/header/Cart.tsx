...
import { Box, Typography, Badge, Drawer, IconButton, Button, Stack } from 'src/shared/components/compat';
import { useSelector } from 'src/app/store';
import { Link } from 'react-router-dom';
import CartItems from 'src/app/layouts/full/vertical/header/CartItem';
