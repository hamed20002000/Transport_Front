...
import { Box, Typography, Avatar, Stack, ButtonGroup, Button } from 'src/shared/components/compat';
...
import { increment, decrement } from 'src/features/ecommerce/model/ECommerceSlice';
