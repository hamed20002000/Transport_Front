...
import CustomizerReducer from 'src/app/store/customizer/CustomizerSlice';
import EcommerceReducer from 'src/features/ecommerce/model/ECommerceSlice';
import ChatsReducer from 'src/features/chat/model/ChatSlice';
import NotesReducer from 'src/features/notes/model/NotesSlice';
import EmailReducer from 'src/features/email/model/EmailSlice';
import TicketReducer from 'src/features/tickets/model/TicketSlice';
import ContactsReducer from 'src/features/contacts/model/ContactSlice';
import UserProfileReducer from 'src/features/profile/model/UserProfileSlice';
import BlogReducer from 'src/features/blog/model/BlogSlice';
